...
W niniejszej pracy do oceny jakoœci algorytmów inicjalizacji t³a u¿yto pierwszych 200 ramek nastêpuj¹cych sekwencji wideo:
\begin{enumerate}
...
\item clip\_02.mpg - jak w~pkt. 1, lecz sekwencja jest zarejestrowana w~gorszej jakoœci obrazu.
...
W celu porównania skutecznoœci algorytmów dla ka¿dej z~wy¿ej wymienionych sekwencji zosta³y wyliczone modele t³a z~u¿yciem ró¿nych metod i~wspó³czynników. Obliczenia zosta³y przeprowadzone na ramkach w 8 bitowej skali szaroœci.

Dla metod wykorzystuj¹cych transformatê DCT oraz rekursywn¹ transformatê Hadamarda obliczenia zosta³y wykonane dla wartoœci wspó³czynnika $T_{corr} =  \{ 0.6, 0.7, 0.8, 0.9 \}$ oraz $T_{MAD} =  \{ 10, 20 \}$.
...
Metryka ta okreœla liczbê pikseli o~danej wartoœci, pos³u¿y ona do wizualnej oceny ró¿nic obrazów.
...
Metryka ta okreœla ró¿nicê liczby pikseli o~danej wartoœci
