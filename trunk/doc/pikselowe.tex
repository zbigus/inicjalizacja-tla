...
Mediana z~bufora ramek jest kolejn¹ z prostych metod inicjalizacji t³a. Do zainicjalizowania t³o u¿ywa ona ca³ego bufora ramek. Algorytm ten opiera siê na wyliczaniu mediany dla ka¿dej pozycji piksela na obrazie spoœród ramek zgromadzonych w~buforze.
...
\noindent gdzie $B(x,y)$ oznacza wartoœæ piksela t³a w~miejscu (x,y), $P(x,y)$ oznacza zbiór wartoœæ piksela na pozycji (x,y) we wszystkich ramkach w buforze,  $P_{i}(x,y)$ oznacza wartoœæ piksela na pozycji (x,y) \newline w $i$-tej ramce, gdzie $i \in \{1,2,\dots,n\}$.
